...
public class RobotContainer {
  ...
  private final JoystickButton lock =
      new JoystickButton(driver, PS4Controller.Button.kOptions.value);
  private final JoystickButton autoIntake =
      new JoystickButton(driver, PS4Controller.Button.kR1.value);
  private final JoystickButton hybrid =
      new JoystickButton(driver, PS4Controller.Button.kCross.value);
  private final JoystickButton mid = new JoystickButton(driver, PS4Controller.Button.kSquare.value);
  private final JoystickButton fastShot =
      new JoystickButton(driver, PS4Controller.Button.kTriangle.value);
  private final JoystickButton purple =
  ...
  private final JoystickButton pivotDown =
      new JoystickButton(driver, PS4Controller.Button.kR3.value);
  ...
  public RobotContainer() {
    ...
    s_Chooser.addOption(
        "Mid Shot",
        new EjectCube(s_Intake, IntakeConstants.hightakeSpeed).until(s_Intake::outakeAutoDone));
    ...
    s_Chooser.addOption("Multi", new MultiPath(s_Swerve, s_Intake));
