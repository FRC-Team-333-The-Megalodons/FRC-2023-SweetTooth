...
public class SwerveModule {
  ...
  SimpleMotorFeedforward feedforward =
      new SimpleMotorFeedforward(
          Constants.SwerveDrive.driveKS,
          Constants.SwerveDrive.driveKV,
          Constants.SwerveDrive.driveKA);
    ...
    if (isOpenLoop) {
      ...
      double velocity =
          Conversions.MPSToFalcon(
              ...
              Constants.SwerveDrive.wheelCircumference,
              Constants.SwerveDrive.driveGearRatio);
      mDriveMotor.set(
  ...
  private void setAngle(SwerveModuleState desiredState) {
    Rotation2d angle =
        (Math.abs(desiredState.speedMetersPerSecond) <= (Constants.SwerveDrive.maxSpeed * 0.01))
            ? lastAngle
            : desiredState
    ...
    mAngleMotor.set(
        ...
        Conversions.degreesToFalcon(angle.getDegrees(), Constants.SwerveDrive.angleGearRatio));
    lastAngle = angle;
  }
  ...
  private Rotation2d getAngle() {
    return Rotation2d.fromDegrees(
        Conversions.falconToDegrees(
            mAngleMotor.getSelectedSensorPosition(), Constants.SwerveDrive.angleGearRatio));
  }
  ...
  public void resetToAbsolute() {
    double absolutePosition =
        Conversions.degreesToFalcon(
            ...
            Constants.SwerveDrive.angleGearRatio);
