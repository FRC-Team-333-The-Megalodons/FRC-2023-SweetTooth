...
public class RobotContainer {
    ...
    public RobotContainer() {
        ...
        public RobotContainer() {
            ...
            s_Chooser.addOption("COME_BACK_SCORE", new ComeBackScoreAuto(s_Swerve, s_Intake, s_Pivot));
            s_Chooser.addOption("MOBILITY", new Mobility(s_Swerve));
            s_Chooser.addOption("SCORE_MOBILITY", new ScoreMobility(s_Swerve, s_Pivot, s_Intake));
            s_Chooser.addOption("SHOOT_MOBILITY", new ShootMobility(s_Intake));
